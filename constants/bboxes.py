...
class CONSTANTS:
    ...
    RELATIVE_RACK_DICT = {"rack_1" : RACK_1_RELATIVE, "rack_2" : RACK_2_RELATIVE,
                        "rack_3" : RACK_3_RELATIVE, "rack_4" : RACK_4_RELATIVE}
    ...
    NUMBER_BOXES_PER_SHELVE = {"rack_1" : {1 : [6, 2],2 : [6, 2],3 : [6, 2],4 : [6, 2], }, #num_shelves : [hor, ver ] 
                        "rack_2" : {1 : [3, 3],2 : [3, 3], 3 : [3, 3], 4 : [4, 3]}, 
                        "rack_3" : {1 : [1, 2],2 : [1, 2],3 : [1, 2],},
                        "rack_4" : {1 : [1, 1], 2 : [2, 2], 3 : [1, 1], 4 : [2, 2], 5 : [2, 2], 6 : [1, 1]}}
                        
    RACKS_SHELVE_POSITION = {
        "rack_1" : {1 : [75, 187], 2: [190, 290], 3: [290, 380]},
